...
-s EXTRA_EXPORTED_RUNTIME_METHODS='["ccall", "cwrap", "setValue", "getValue", "writeAsciiToMemory", "lengthBytesUTF8", "stringToUTF8"]' \
-s EXPORTED_FUNCTIONS='["_pico_wstap_create_simple", "_pico_wstap_destroy", "_pico_socket_open_cb", "_pico_socket_read", "_pico_socket_write", "_pico_socket_bind", "_pico_socket_connect", "_pico_socket_listen", "_pico_socket_close", "_pico_socket_accept", "_pico_socket_setoption", "_pico_socket_getoption", "_pico_socket_getpeername", "_pico_socket_getname", "_main"]' \
